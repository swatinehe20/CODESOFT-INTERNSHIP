# CODESOFT-INTERNSHIP
Hello, Everyone I am doing task of CODSOFT internship level 1 this includes total of three tasks which includes ===>> Landing page and simple calculator using HTML, CSS, JavaScript and some of these frameworks. 
